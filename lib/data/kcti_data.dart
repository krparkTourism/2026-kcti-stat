...
class KctiData {
  ...
  static const List<Map<String, dynamic>> wagePeak = [
    ...
    {'year': 2026, 'count': 3, 'names': '김면(1.23.), 이동헌(5.10.), 이상열(7.21.)'},
    {'year': 2027, 'count': 4, 'names': '류광훈(8.17.), 유지윤(9.5.), 서성원(10.27.), 박근화(6.5.)'},
    {'year': 2028, 'count': 2, 'names': '박상준(8.18.), 김현주(4.17.)'},
    {'year': 2029, 'count': 2, 'names': '허은영(5.21.), 한영은(5.4.)'},
    {'year': 2030, 'count': 3, 'names': '오훈성(7.22.), 장훈(2.23.), 박상곤(4.25.)'},
    {'year': 2031, 'count': 4, 'names': '김규원(9.16.), 김영준(9.3.), 전효재(12.1.), 노영순(8.15.)'},
    {'year': 2032, 'count': 5, 'names': '최자은(9.20.), 조현성(9.29.), 김윤영(9.13.), 이윤경(10.6.), 박경열(11.15.)'},
  ];
  ...
  static const List<Map<String, dynamic>> researchProjects = [
    ...
    {'no': 3, 'type': '정책', 'field': '문화', 'title': '문화치유 정책 기반 정립 연구: 인력 기반 중심으로', 'researcher': '윤지연'},
    {'no': 4, 'type': '정책', 'field': '문화', 'title': '공연예술계 표준계약서 운영현황 및 개선방안 연구', 'researcher': '황아람, 허은영'},
    {'no': 5, 'type': '정책', 'field': '문화', 'title': '문화정책 관점에서의 지역균형발전의 의미와 추진전략', 'researcher': '김홍규(김규원)'},
    {'no': 6, 'type': '정책', 'field': '문화', 'title': '박물관·미술관 정책구조의 재편방안 연구', 'researcher': '김혜인'},
    {'no': 7, 'type': '기초', 'field': '문화', 'title': '환경변화에 대응한 문화분야 전문인력 양성 정책 방향 연구', 'researcher': '박종웅(조현성)'},
    {'no': 8, 'type': '정책', 'field': '문화', 'title': '문화참여가 웰빙과 건강에 미치는 영향: 비용·편익 분석을 중심으로', 'researcher': '변지혜, 이정희'},
    ...
    {'no': 17, 'type': '정책', 'field': '관광', 'title': '방한 중국관광시장 분석 및 중장기 대응방향', 'researcher': '유지윤, 정광민, 손신욱'},
    {'no': 18, 'type': '기초', 'field': '관광', 'title': '인공지능(AI) 시대 관광산업 생태계 변화와 혁신 방안 연구', 'researcher': '류광훈, 정광민'},
    {'no': 19, 'type': '정책', 'field': '관광', 'title': '국내 카지노산업의 구조 분석과 성장을 위한 정책과제', 'researcher': '김영준, 김성윤'},
    {'no': 20, 'type': '정책', 'field': '관광', 'title': '지자체 간 연계·협력 관광사업 실태와 활성화 방안', 'researcher': '전효재, 송수엽'},
    ...
    {'no': 23, 'type': '정책', 'field': '관광', 'title': '5극3특 국토균형전략과 초광역권 관광정책 방향', 'researcher': '진보라, 박주영'},
    {'no': 24, 'type': '정책', 'field': '관광', 'title': '민간투자 촉진을 위한 관광단지 제도 개선방안', 'researcher': '양지훈'},
    {'no': 25, 'type': '기초', 'field': '콘텐츠', 'title': '한류 트렌드 분석과 전망', 'researcher': '박찬욱, 김예솔'},
    {'no': 26, 'type': '정책', 'field': '콘텐츠', 'title': '애니메이션 기획개발 기반 강화 방안 연구', 'researcher': '홍무궁'},
    ...
    {'no': 30, 'type': '정책', 'field': '데이터', 'title': 'AI 친화적 문화관광콘텐츠 데이터 발굴을 위한 기반 조성 연구', 'researcher': ''},
  ];
}
